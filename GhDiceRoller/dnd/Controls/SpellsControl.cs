...
namespace dnd.Controls
{
    internal class DescriptorControl : UserControl
    {
        ...
        private dnd.Cards.TopCard topCard1;
        private Hero hero;
        private List<dnd.Classes.Descriptor> dList;
        ...
        public DescriptorControl(Hero hero, string type)
        {
            ...
            this.hero = hero;
            var a = hero.spells;
            List<dnd.Classes.Descriptor> list = new List<dnd.Classes.Descriptor>();
            switch (type)
            {
                case "spell":
                    dList = hero.spells;
        ...
        private void InitializeComponent()
        {
            ...
            this.topCard1 = new dnd.Cards.TopCard();
        ...
        {
            this.FlowPnl.Controls.Add(new dnd.Cards.DescriptorsControl());
